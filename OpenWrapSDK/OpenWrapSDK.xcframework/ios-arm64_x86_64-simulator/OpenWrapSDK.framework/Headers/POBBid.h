...
/*!
 ...
 @see POBBidSummary
 @deprecated Deprecated in v3.6.0 and will be removed in future releases.
 */
@property (nonatomic, readonly) NSArray<POBBidSummary *> *summary __attribute__((deprecated));
